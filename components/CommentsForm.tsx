    ...
    <div className="mb-8 rounded-lg bg-white p-8 pb-12 shadow-lg">
      ...
      <div className="mb-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
        <input
          type="text"
          ref={nameEl}
          className="w-full rounded-lg bg-gray-100 p-4 py-2 text-gray-700 outline-none focus:ring-2 focus:ring-gray-200"
          placeholder="Name"
          name="name"
        />
        <input
      ...
      <div className="mt-8">
        <button
          ...
          className="transision ease inline-block cursor-pointer rounded-full bg-pink-600 px-8 py-3 text-lg text-white duration-500 hover:bg-indigo-900"
        >
          Post Comment
        </button>
        {showSuccessMessage && (
